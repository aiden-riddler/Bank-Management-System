...
public class CustomerController {
    public static void createCustomer(Customer customer, Context context, ConstraintLayout progressCard, Branch branch, Button submit, User user1) {
    ...
    public static void removeCustomer(Customer customer, Context context, User user) {
        FirebaseFirestore db = FirebaseFirestore.getInstance();
    ...
    public static void updateCustomer(Customer customer, Context context, Customer prevCust, ConstraintLayout progressCard, Button submit, User user){
        FirebaseFirestore db = FirebaseFirestore.getInstance();
        WriteBatch batch = db.batch();
